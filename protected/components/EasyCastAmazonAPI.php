 ...
 * 
 * @todo добавить стандартную функцию, которая будет выводить подробную информацию о 
 *       выполнении процесса если скрипт запущен из консоли 
 ...
 * @todo создать отдельную очередь для тестовых сообщений
 * @todo в тестовом режиме отправлять все письма на один адрес
 */
