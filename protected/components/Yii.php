...
// по умолчанию используем пространство имен Yii2
use yii\BaseYii;

/**
 * Базовый класс Yii комбинирующий первую и вторую версии фреймворка в одном приложении
 * 
 * @see http://www.yiiframework.com/doc-2.0/guide-tutorial-yii-integration.html#using-yii-2-with-yii-1
 * 
 * @property \yii\web\Application $app the application instance
