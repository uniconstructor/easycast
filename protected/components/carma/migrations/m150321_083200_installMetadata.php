        ...
        $tables = array(
            ...
            'meta_links' => array(
                'columns' => array(
                    ...
                    'name'            => 'string',
                    'title'           => 'string',
                    'linkpointerid'   => "bigint NOT NULL DEFAULT 0", // mediator
            ...
            'model_attributes' => array(
                'columns' => array(
                    ...
                    'defaultvalue'  => 'text',
                    //'singlevalueid' => "bigint NOT NULL DEFAULT 0",
                    'timecreated'   => "bigint NOT NULL DEFAULT 0",
                    'timemodified'  => "bigint NOT NULL DEFAULT 0",
                ),
            ...
            'forms' => array(
                'columns' => array(
                    ...
                    'ajaxvalidation'    => "boolean NOT NULL DEFAULT 1",
                    'timecreated'       => "bigint NOT NULL DEFAULT 0",
                    'timemodified'      => "bigint NOT NULL DEFAULT 0",
                ),
                'no_index' => array('description'),
            ...
            'form_fields' => array(
                'columns' => array(
                    ...
                    'visibleoncreate'  => "boolean NOT NULL DEFAULT 1",
                    'visibleonupdate'  => "boolean NOT NULL DEFAULT 1",
                    'name'             => 'string NOT NULL',
                    'label'            => 'string',
                    'description'      => 'text',
                    'hinttext'         => 'text',
