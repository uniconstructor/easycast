...
class ActiveDateSelect extends CInputWidget
{
	...
	/** Creates 12:00 timestamp from array
	 * 
	 * @param array $value - POST field data
	 * 
	 * @return int unix timestamp
	 */
	public static function make_unixtime($value)
	{
	    return mktime(12, 0, 0, $value['Month'], $value['Day'], $value['Year']);
	}
