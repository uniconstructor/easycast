...
<div class="row-fluid" style="padding-bottom:20px;">
    ...
    <div class="span9">
        ...
        <p class="profile-description">
            Я знаю Николая Гришина, основателя компании easyCast достаточно давно, и являюсь свидетелем его карьеры. 
            Это очень приятно, так как он развивался на моих глазах и сумел построить компанию, 
            которой можно доверить организацию огромного процесса. Очень мало в наше время людей, 
            с навыками делать что-то эффективно и доводить дело до конца, взять и качественно спланировать и 
            стрруктурно выполнить все поставленные задачи. Команда easyCast это умеет.
            Я это давно наблюдаю, давно это вижу и более того, я с easyCast работаю.
        </p>
    </div>
</div>
<div class="row-fluid" style="padding-bottom:20px;">
...
<div class="row-fluid" style="padding-bottom:20px;">
    ...
    <div class="span9">
        ...
        <p class="profile-description">
            Кастинг-агентсво easyCast действительно помогают мне воплощать самые смелые 
            творческие задумки в реальность. Для моих клипов я часто подбираю нестандартых, 
            аутентичных персонажей. Мои друзья - команда easyCast быстро и качественно 
            справляются со всеми поставленными задачами, настоящие профессионалы своего дела.
        </p>
    </div>
</div>
<div class="row-fluid" style="padding-bottom:20px;">
