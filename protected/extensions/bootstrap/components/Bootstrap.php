...
class Bootstrap extends CApplicationComponent
{
    ...
    /**
     * Registers the Awesome Font CSS [http://fortawesome.github.com]
     * (Really awesome!) :)
     */
    ...
    /**
     * Registers the Brandico Font CSS [https://github.com/fontello/brandico.font]
     */
    public function registerBrandicoCss()
    {
        $filename =  'brandico.css'; //YII_DEBUG ? 'brandico.css' : 'font-awesome.min.css';
        Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/'.$filename);
    }
