    ...
    public function safeUp()
    {
        ...
        $mailBlocks = array(
            array(
                ...
                'description' => 'Если имя участника неизвестно - текст будет заменен на безличное обращение',
            ),
            array(
                'name'        => 'О проекте',
                'value'       => '{$projectDescription}',
                'description' => 'Будет скопировано описание из проекта в котором находится роль',
            ),
            array(
                'name'        => 'О событии',
                'value'       => '{$eventDescription}',
                'description' => 'Заголовком этого блока будет название мероприятия в котором содержится роль',
            ),
            array(
                'name'        => 'Список ролей',
                'value'       => '{$vacancies}',
                'description' => 'Будут перечислены все роли которые подходят участнику. '.
