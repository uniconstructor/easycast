 ...
 * @deprecated этот класс создавался как временная замена недостаточно универсальному на тот момент
 *             виджету searchFilters. Теперь рефакторинг виджета searchFilters выполнен
 *             и от этого виджета можно отказаться
 * @todo удалить этот виджет, вместо него использовать общее решение на базе SearchFilers
 */
