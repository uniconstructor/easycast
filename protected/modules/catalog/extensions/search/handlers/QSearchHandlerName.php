...
class QSearchHandlerName extends QSearchHandlerBase
{
    ...
    protected function createCriteria()
    {
        ...
        if ( mb_ereg(' ', $name) )
        {// Если в поле введены и имя и фамилия - то
            // разбиваем строку по пробелам для того чтобы отделить имя от фамилии при дальнейшем поиске
            $parts = explode(' ', $name);
            ...
            $criteria->addInCondition('lastname', $parts);
        }else
