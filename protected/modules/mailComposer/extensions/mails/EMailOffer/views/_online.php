...
$textStyle         = 'text-indent:20px;font-face:tahoma,sans-serif;color:#17414c;text-align:justify;font-weight:200;background-color:#fff;border-radius:10px;padding:8px;';
...
<tbody>
	...
	<tr>
		...
		<td width="500" height="100" valign="middle">
            <h3><?= $docsHeader; ?></h3>
			<p style="<?= $textStyle; ?>">
			Наша умная система на основе сформированного заказа автоматически генерирует 
