...
<table class="w640" width="640"  border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td width="134">
				<a href="#"><img src="<?= Yii::app()->createAbsoluteUrl('/images/offer/serv1.png'); ?>" width="134"></a>
			</td>
			<td width="147">
				<a href="#"><img src="<?= Yii::app()->createAbsoluteUrl('/images/offer/serv2.png'); ?>"  width="147" /></a>
			</td>
			<td width="144">
				<a href="#"><img src="<?= Yii::app()->createAbsoluteUrl('/images/offer/serv3.png'); ?>" width="144"></a>
			</td>
			<td width="133">
				<a href="#"><img src="<?= Yii::app()->createAbsoluteUrl('/images/offer/serv4.png'); ?>"  width="133" /></a>
			</td>
