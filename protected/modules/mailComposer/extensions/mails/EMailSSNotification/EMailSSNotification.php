...
class EMailSSNotification extends EMailBase
{
    ...
    protected function createAboutBlock()
    {
        ...
        $text .= 'В 2014 году мы запускаем '.$siteLink.' - первый автоматизированный ресурс для поиска актеров, '; 
        ...
        $text .= 'начнет поступать вам в ближайшие пару месяцев - с момента официального запуска системы. ';
