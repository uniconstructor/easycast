    ...
    public function safeUp()
    {
        ...
        $fields = array(
            ...
            array(
                ...
                'description' => 'В случае положительного ответа, укажите названия конкурсов',
            ),
            array(
                'name'        => 'tm_parentwork',
                'type'        => 'textarea',
            ...
            array(
                'name'        => 'tm_emotions',
                'type'        => 'textarea',
                'label'       => 'Что может вызвать у вас наибольшую радость? 
                    Что может причинить боль и страдания?',
                'description' => '',
            ),
            array(
                'name'        => 'tm_fears',
            ...
            array(
                'name'        => 'tm_hero',
                'type'        => 'textarea',
                'label'       => 'Есть ли в вашей жизни кумир, на которого вы хотела бы равняться?',
