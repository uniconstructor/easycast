...
class ProjectMember extends CActiveRecord
{
    ...
    /**
     * @var string - статус заявки: требуются дополнительные данные от участника.
     *               Заявка подана и возможно была предварительно одобрена, но для дальнейшего
     *               кастинга или съемок нежны дополнителоьные данные от участника
     *               
     */
