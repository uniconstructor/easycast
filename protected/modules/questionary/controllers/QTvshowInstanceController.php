...
/**
 * Контроллер для работы со списком проектов телеведущего
 *
 * @package    easycast
 * @subpackage questionary
 */
class QTvshowInstanceController extends QComplexValueController
{
    /**
     * @var string - класс модели сложного значения
     */
    protected $modelClass = 'QTvshowInstance';
}