 ...
 * 
 * Да, сразу же в добавленой строке таблицы можно править значения в отдельных ячейках
 ...
 * 
 * Это самый полезный и часто используемый виджет ввода во всей системе
 * 
 ...
 * @todo удалить все закомментированные функции после слияния с EditableGrid
