...
/**
 * This is the model class for table "{{rds_value_float}}".
 *
 * The followings are the available columns in table '{{rds_value_float}}':
 * @property integer $id
 * @property double $value
 * @property integer $timecreated
 * @property integer $timemodified
 */
class RdfValueFloat extends CActiveRecord
{
    /**
     ...
     * @return RdsValueFloat the static model class
     */
