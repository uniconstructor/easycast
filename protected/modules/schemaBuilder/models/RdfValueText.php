...
/**
 * This is the model class for table "{{rds_value_text}}".
 *
 * The followings are the available columns in table '{{rds_value_text}}':
 * @property integer $id
 * @property string $value
 * @property integer $timecreated
 * @property integer $timemodified
 */
class RdfValueText extends CActiveRecord
{
    /**
     ...
     * @return RdsValueText the static model class
     */
