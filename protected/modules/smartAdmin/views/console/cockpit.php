...
//require_once(Yii::app()->getBasePath()."/protected/components/cockpit/bootstrap.php");
//echo 'COCKPIT';

define('COCKPIT_ADMIN', 1);
/// easycast ///
define('COCKPIT_CONFIG_PATH', Yii::app()->getBasePath().'/components/cockpit/config/config.php');
define('COCKPIT_DIR'        , Yii::app()->getBasePath().'/components/cockpit/lib/');
//define('COCKPIT_DIR'        , Yii::app()->getBasePath().'/components/cockpit/lib/');
...
Yii::app()->getComponent('cockpit')->initCockpit();
