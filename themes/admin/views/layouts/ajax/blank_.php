<?php 
/**
 * Минимальная разметка одной страницы 
 * Не изменяйте название файла - он так назывался в оригинальной теме оформления, поэтому
 * переименование может иметь побочные эффекты 
 * 
